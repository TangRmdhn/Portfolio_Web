          ...
          <div className="px-4 py-4 space-y-2">
            {navItems.map((item) => {
              ...
              return (
                <Link key={item.path} href={item.path}>
                  <a
                    className={`flex items-center gap-3 px-4 py-4 rounded-lg font-medium transition-colors hover-elevate active-elevate-2 ${isActive ? "bg-accent text-accent-foreground" : "text-foreground"
                      }`}
