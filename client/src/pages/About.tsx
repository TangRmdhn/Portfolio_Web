...
export default function About() {
    ...
    return (
        <div className="min-h-screen bg-background text-foreground font-sans selection:bg-primary/20">
            ...
            <main className="pt-24 pb-16 px-6 md:px-8 max-w-7xl mx-auto space-y-20">
                {/* Header Section */}
                <section className="space-y-6 text-center max-w-3xl mx-auto">
                    <h1 className="text-4xl md:text-5xl font-bold font-serif">About Me</h1>
                ...
                <section className="grid md:grid-cols-2 gap-10 items-center">
                    <div className="space-y-10">
                        <h2 className="text-4xl font-bold font-serif">Who I Am</h2>
                ...
                <section className="grid md:grid-cols-2 gap-8 ">
                    <div className="space-y-6">
                        <div className="flex items-center gap-3 mb-2">
                            ...
                            <h2 className="text-3xl font-bold font-serif">Education</h2>
                        </div>
                        <Card className="bg-card hover:border-primary/50 transition-colors h-full">
                            <CardContent className="p-6 space-y-4">
                                <div>
                                    ...
                                    <p className="text-primary font-medium"><a href="https://www.upnyk.ac.id/" target="_blank">Universitas Pembangunan Nasional "Veteran" Yogyakarta</a></p>
                                </div>
                ...
                <section className="space-y-8">
                    <h2 className="text-3xl font-bold font-serif text-center">Certifications</h2>
                ...
                {/* Awards Section */}
                <section className="space-y-8">
                    <h2 className="text-3xl font-bold font-serif text-center">Awards & Achievements</h2>
                    <div className="grid md:grid-cols-2 gap-6">
                ...
                <section className="text-center space-y-8 py-12 bg-accent/30 rounded-3xl border border-border/50">
                    <h2 className="text-3xl font-bold font-serif">Let's Connect</h2>
                    ...
                    <div className="flex flex-wrap justify-center gap-4">
                        ...
                        <a href="https://wa.me/62889638790525" target="_blank" rel="noopener noreferrer">
                            <Button size="lg" variant="outline" className="gap-2">
                                <Phone className="w-4 h-4" />
                                +62 889-638-790-525
                            </Button>
                        </a>
                        <a href="https://www.linkedin.com/in/tang-ramadhan/" target="_blank" rel="noopener noreferrer">
                            <Button size="lg" variant="outline" className="gap-2">
                                <Linkedin className="w-4 h-4" />
                                LinkedIn
                            </Button>
                        </a>
                        <a href="https://github.com/TangRmdhn" target="_blank" rel="noopener noreferrer">
                            <Button size="lg" variant="outline" className="gap-2">
